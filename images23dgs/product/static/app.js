...
function collectParams(){
  ...
  for(const [key,value] of Object.entries({
    ...
    gsplat_adaptive_densify_every:numberValue('gsplatAdaptiveEvery'),
    gsplat_adaptive_densify_start:numberValue('gsplatAdaptiveStart'),
    gsplat_adaptive_densify_stop:numberValue('gsplatAdaptiveStop'),
    gsplat_adaptive_densify_points:numberValue('gsplatAdaptivePoints'),
    gsplat_preview_frames:numberValue('gsplatPreviewFrames'),
